---
title: "On using and extending the `MsBackendRawFileReader`"
author:
...
```{r readSpecs,eval=FALSE, echo=FALSE}
...
```{r lattice::xyplot, echo=FALSE, fig.retina=3, eval=FALSE}
