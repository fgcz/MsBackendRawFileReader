...
Next, we generate a mgf file for each scan type. This is helpful, e.g, for optimizing search settings tandem mass spectrometry sequence database search tool as comet @comet2012.
