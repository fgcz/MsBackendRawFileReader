...
a Mascot Generic File (see also http://www.matrixscience.com/help/data_file_help.html#GEN)
...
To extract all MS2 spectra you can use the code snippet below
